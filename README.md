...
[![Version](https://img.shields.io/npm/v/@xdanangelxoqenpm/ratione-modi-a.svg?style=for-the-badge)](https://www.npmjs.com/package/@xdanangelxoqenpm/ratione-modi-a)
[![npm](https://img.shields.io/npm/dt/@xdanangelxoqenpm/ratione-modi-a.svg?style=for-the-badge)](https://www.npmjs.com/package/@xdanangelxoqenpm/ratione-modi-a)
...
**Try it out for yourself on [Expo Snack](https://snack.expo.dev/@nuumi/@xdanangelxoqenpm/ratione-modi-a-demo)!** Make sure to run it on a mobile to see it working properly.
...
```bash
npm install @xdanangelxoqenpm/ratione-modi-a
```

or

```bash
yarn add @xdanangelxoqenpm/ratione-modi-a
```
...
```jsx
import { TimerPickerModal } from "@xdanangelxoqenpm/ratione-modi-a";
...
```jsx
import { TimerPicker } from "@xdanangelxoqenpm/ratione-modi-a";
import { LinearGradient } from "expo-linear-gradient"; // or `import LinearGradient from "react-native-linear-gradient"`
